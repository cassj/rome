...
function upload_file (){
    ...
    //submit the form
    $('process_upload_form').request(({ method: 'post', enctype:'multipart/form-data'}));

    //tell the user you've done so
    $('upload_results').innerHTML='<span class="message">File Uploaded</span>';

}


function update_upload_list(divid){
  var uul_url = '/upload/list';

  //need to eval scripts to set the toggles
  var uulAjax = new Ajax.Updater( divid, uul_url,{evalScripts: true});
}



/*
   Catalyst::Plugin::UploadProgress progress.js
*/
...
/*
 Catalyst::Plugin::UploadProgress progress.jmpl.js
