...
pod2usage(1) unless $helper->mk_component( 'ROME', @ARGV );

1;

=head1 NAME

rome_create.pl - Create a new Catalyst Component

=head1 SYNOPSIS

rome_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   rome_create.pl controller My::Controller BindLex
