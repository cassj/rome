package Catalyst::Helper::View::BioseqView;

use strict;

=head1 NAME

Catalyst::Helper::View::BioseqView - Helper for BioseqView Views

=head1 SYNOPSIS

    script/create.pl view BioseqView BioseqView

=head1 DESCRIPTION

Helper for BioseqView Views.
